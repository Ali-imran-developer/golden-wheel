            ...
            <div className="hidden md:flex items-center space-x-2 lg:space-x-4">
              ...
              <Link to="/register">
                <Button 
                  variant="casino" 
                  size="sm" 
                  className="bg-primary text-primary-foreground hover:bg-primary/90 font-bold shadow-lg shadow-primary/50 text-sm md:text-base px-4 md:px-6"
                >
                  Sign Up Free
                </Button>
              </Link>
            ...
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-casino-dark/50 rounded-lg mt-2 mb-4">
              ...
              <div className="pt-3 space-y-2 border-t border-border mt-2">
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="block px-3 py-2 rounded-md text-sm font-medium text-muted-foreground hover:text-primary hover:bg-muted casino-transition"
                  onClick={() => setIsOpen(false)}
                >
                  My Account
                </a>
