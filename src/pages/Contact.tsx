  ...
  const contactInfo = [
    {
      icon: MapPin,
      title: "Our Location",
      details: ["Beijing Gaming Center", "123 Casino Boulevard", "Beijing, China 100000"],
    },
    {
      icon: Phone,
      title: "Phone Support",
    ...
    },
    {
      icon: Mail,
      title: "Email Support",
      details: ["support@beijing-casino.com", "vip@beijing-casino.com", "Response within 2 hours"],
    },
    {
      icon: Clock,
